...
#
#    # Ensure we're linking directly to an image,
#	# not a gallery etc.
#	valid_urls = urls.select{|url|
#		url.downcase.end_with?('png', 'gif', 'jpg', 'jpeg')}
#	send_event('aww', image:
#			   "background-image:url(#{valid_urls.sample(1).first})")
#  end
#end
